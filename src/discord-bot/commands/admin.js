            ...
            .addStringOption((option) =>
              option.setName('type')
                ...
                .addChoices(
                  ...
                  { name: LICENSE_TYPE.ULTRA.name, value: LICENSE_TYPE.ULTRA.id },
                  { name: LICENSE_TYPE.FREE2.name, value: LICENSE_TYPE.FREE2.id}
                ))
      ...
      const commands = {
        'generate': async () => {
          try {
            ...
            console.log(`Generating ${amount} license key(s) of type ${licenseTypeName} (${licenseTypeId})`);
